...
async def _run_chat_pipeline(request: ChatRequest, stream_tokens: bool = False) -> AsyncIterator[str]:
    ...
    primary_system = SystemMessage(content=(
        ...
        "RICH FORMATTING REQUIRED: You MUST use Markdown tables to compare data, bulleted lists for tech stacks, and `code blocks` for technical terms. Make the output visually structured and engaging.\n"
